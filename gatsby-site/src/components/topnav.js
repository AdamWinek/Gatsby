...
const Topnav = props => {
  ...
  const fadeProps = useSpring({
    ...
    to: [
      { background: props.isNav ? "white" : "black" },
      {
        opacity: props.isNav ? 0 : 1,
        background: props.isNav ? "white" : "black",
      },
    ],
  })
  ...
  const rotateUp = useSpring({
    ...
    to: [
      ...
      {
        position: "absolute",
        transform: props.isNav
          ? "rotate(-45deg)  translateX(7.1px) translateY(-7.1px)"
  ...
  const rotateDown = useSpring({
    ...
    to: [
      { background: props.isNav ? "white" : "black" },
      {
        position: "absolute",
        transform: props.isNav
          ? "rotate(45deg) translateY(7.1px) translateX(7.1px)"
